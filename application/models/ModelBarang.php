...
class ModelBarang extends CI_Model
{
    ...
    public function dataPria(){
        return $this->db->get_where("barang", array('kategori' => 'Fashion Pria'));
    }

    public function dataWanita(){
        return $this->db->get_where("barang", array('kategori' => 'Fashion Wanita'));
    }

    public function dataAnak(){
        return $this->db->get_where("barang", array('kategori' => 'Fashion Anak-Anak'));
    }
